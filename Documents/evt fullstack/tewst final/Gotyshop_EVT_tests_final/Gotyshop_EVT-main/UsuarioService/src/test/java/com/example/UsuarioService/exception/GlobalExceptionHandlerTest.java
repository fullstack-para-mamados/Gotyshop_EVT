...
class GlobalExceptionHandlerTest {
    ...
    void validacionRetornaDetalles() {
        ...
        BeanPropertyBindingResult binding = new BeanPropertyBindingResult(target, "usuario");
        binding.addError(new FieldError("usuario", "email", "El email es obligatorio"));
        ...
        assertEquals("El email es obligatorio", detalles.get("email"));
    }
